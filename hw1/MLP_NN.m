...
nbrOfNeuronsInEachHiddenLayer = [4 3]; %linear:[4] - circle:[10] - wave,spirals:[10 10]
nbrOfOutUnits = 2;
...
enable_learningRate_momentum = 1; %1 for enable, 0 for disable
momentum_alpha = 0.05;

draw_each_nbrOfEpochs = 1000;
...
if(min(TargetClasses) <0)
TargetClasses( TargetClasses < 0) = 0;
else
